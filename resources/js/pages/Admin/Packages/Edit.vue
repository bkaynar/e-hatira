...
const form = useForm({
    ...
    max_uploads: props.package.max_uploads || undefined,
    storage_days: props.package.storage_days,
    upload_days: props.package.upload_days,
    quality: props.package.quality,
    advanced_customization: props.package.advanced_customization,
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            <div>
                <h1 class="text-2xl font-bold text-foreground">Edit Package</h1>
                <p class="text-muted-foreground">Edit package: {{ props.package.name }}</p>
            </div>
